...
namespace 日报模板
{
    public partial class Repairtestrevise : Form
    {
        public Repairtestrevise()
        {
            InitializeComponent();
        ...
        public Repairtestrevise(DataRowView dv): this() //从Repairtestlookup传来的数据
        {
        ...
        {
            SqlConnection conn = Class1.GetSqleverconn();
            string sql = "update Repairtest set time ='" + dateTimePicker1.Value + "', name = '" + textBox1.Text + "',model ='" + comboBox1.Text + "',number = '" + textBox2.Text + "', holder ='" + textBox3.Text + "',mac = '" + textBox6.Text + "',firmware = '" + textBox7.Text + "',problemdescription = '" + textBox4.Text + "',remarks = '" + textBox5.Text + "'where ID ='" + textBox8.Text + "'";
