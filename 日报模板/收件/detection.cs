...
namespace 日报模板
{
    public partial class detection : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dateTimePicker1.Text = DateTime.Now.ToString();
            SqlConnection conn = Class1.GetSqleverconn();
            string sql = "insert into detection(time,name,model,number,holder,mac,firmware,problemdescription,remarks) values( '" + dateTimePicker1.Value + "','" + textBox1.Text + "','" + comboBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox6.Text + "','" + textBox7.Text + "','" + textBox4.Text + "','" + textBox5.Text + "') ";
        ...
        private detectionlookup d3;
        private void button2_Click(object sender, EventArgs e)
        {
            if (d3 == null || d3.IsDisposed)
            {
                d3 = new detectionlookup();
                d3.Show();
            }
            else
            {
